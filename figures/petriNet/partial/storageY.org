# PlacesBegin
#+ATTR_LATEX: :caption  \caption{Storage Unit (Y axis) Module Places.} :placement [H] :align M{5cm}M{10cm}
| Places | Meaning                        |
|--------+--------------------------------|
...
# TransitionsBegin
#+ATTR_LATEX: :caption  \caption{Storage Unit (Y axis) Module Transitions.} :placement [H] :align M{5cm}M{10cm}
| Transitions | Meaning          |
|-------------+------------------|
| tt105       | T=2s             |
| tt106       | T=2s             |
