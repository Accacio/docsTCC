...
The complete \LD{} of the example depicted in \Autoref{fig:communicationPlcPN} is shown in \autoref{fig:communicationPlcPNLadder}.
...
and $p_1^2,p_2^2,p_3^2$ as input of \Autoref{alg:identification}, two models can be identified, one for $k=1$ and another for
$k=2$.
...
The language generated by the identified model:
\begin{align}
