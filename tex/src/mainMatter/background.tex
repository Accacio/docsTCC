...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    % \begin{scope}[x={(image.south east)},y={(image.north west)}]
        ...
        \draw[ultra thick,rounded corners] (3.5,0) rectangle (6.5,2);
        \draw[ultra thick,rounded corners] (0.5,3) rectangle (3.5,5);
        \draw[ultra thick,rounded corners] (6.5,3) rectangle (9.5,5);
        \draw[ultra thick,rounded corners] (3.5,6) rectangle (6.5,8);
        \draw (5,7) node {Controller};
        \draw (5,1) node {Plant};
        \draw (2,4) node {Actuators};
        \draw (8,4) node {Sensors};
        % \draw (0,5) node {\textbf{Inputs}};
        % \draw[red] (5,5) node {\huge \textbf{TODO}};
        % \draw (10,5) node {\textbf{Outputs}};
        \draw[->,>=stealth, very thick] (2,3) -- (2,1) -- (3.5,1);
        \draw[->,>=stealth, very thick] (3.5,7) -- (2,7) -- (2,5);
        \draw[->,>=stealth, very thick] (6.5,1) -- (8,1) -- (8,3);
        \draw[->,>=stealth, very thick] (8,5) -- (8,7) -- (6.5,7);



        \draw[->,>=stealth, very thick] (2,5.5) -- (10,5.5);
        \draw[fill] (2,5.5) circle(.05);

        \draw[->,>=stealth, very thick] (8,6.5) -- (10,6.5);
        \draw[fill] (8,6.5) circle(.05);

        \draw (12,6) node {Observed Signals};
