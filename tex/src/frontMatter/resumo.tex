...
Este trabalho tem como objetivo propor ferramentas e mostrar a implementação de um método
...
o projeto de controle de uma planta mecatrônica de manufatura, utilizando
...
\gls{DAOCT}.
Cada um desses passos será descrito nesse trabalho e o modelo identificado
será discutido.
\end{abstract}
