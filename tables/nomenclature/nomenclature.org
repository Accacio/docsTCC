...
#+ATTR_LATEX: :caption \caption{Inputs CLP1} :align c|c|c
| Input                                      | Address | Tag        |
|--------------------------------------------+---------+------------|
...
#+ATTR_LATEX: :caption \caption{Inputs CLP2} :align c|c|c
| Input                              | Address | Tag        |
|------------------------------------+---------+------------|
...
| Relay                              | I2.5    | I_RELAY2   |
| Horizontal Encoder B10             | I1.4    | I_HZENCB10 |
| Storage Unit Right Limit Switch    | I1.6    | I_SURLS    |
| Storage Unit Left Limit Switch     | I1.5    | I_SULLS    |
| Horizontal Encoder B15             | I1.7    | I_HZENCB15 |

#+ATTR_LATEX: :caption \caption{Outputs CLP2} :align c|c|c
| Output                         | Address | Tag        |
|--------------------------------+---------+------------|
