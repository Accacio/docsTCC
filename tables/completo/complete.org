#+ATTR_LATEX: :caption \caption{Complete Places.} :environment longtable :align m{5cm}m{5cm}
| Places | Meaning |
|----+---------|
...
#+ATTR_LATEX: :caption \caption{Complete Transitions.} :environment longtable :align m{5cm}m{5cm}
| Transitions | Meaning |
|----+---------|
