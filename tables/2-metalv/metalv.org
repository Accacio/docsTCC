...
#+ATTR_LATEX: :caption \caption{Metal Half-cube Selection Module Places.} :align cc
| Places | Meaning                             |
|--------+-------------------------------------|
| p28    | MAG1 Empty                          |
| p29    | MAG1 Not Empty                      |
...
#+ATTR_LATEX: :caption  \caption{Metal Half-cube Selection Module Transitions.} :align cc
| Transitions | Meaning                                             |
|-------------+-----------------------------------------------------|
