...
#+ATTR_LATEX: :caption  \caption{Arm From Press To Storage Unit Module Places.} :align cc
| Places | Meaning                                               |
|--------+-------------------------------------------------------|
...
#+ATTR_LATEX: :caption  \caption{Arm From Press To Storage Unit Module Transitions.} :align cc
| Transitions | Meaning                                                    |
|-------------+------------------------------------------------------------|
