...
#+ATTR_LATEX: :caption  \caption{Plastic Half-cube Selection Module Places.} :align cc
| Places | Meaning                             |
|--------+-------------------------------------|
| p51    | MAG2 Empty                          |
| p52    | MAG2 Not Empty                      |
...
#+ATTR_LATEX: :caption  \caption{Plastic Half-cube Selection Module Transitions.} :align cc
| Transitions | Meaning                                                         |
|-------------+-----------------------------------------------------------------|
