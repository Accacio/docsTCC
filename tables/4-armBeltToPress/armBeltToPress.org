...
#+ATTR_LATEX: :caption  \caption{Arm From Conveyor Belt to Press Module Places.} :align cc
| Places | Meaning                                                    |
|--------+------------------------------------------------------------|
| p74    | Raise Arm                                                  |
...
| p79    | Turn HSC On e Raise Arm, Turn Vacuum On and  Rotate Arm CW |
| p80    | Raise and Extend Arm and Turn Vacuum On                    |
| p81    | Extend Arm and  Turn Vacuum On                             |
| p82    | Extend Arm                                                 |
| p83    | Raise and Extend Arm                                       |
| p84    | Raise Arm                                                  |
| p85    | Turn HSC On, Raise Arm and Rotate Arm CCW                  |
| p86    | Raise Arm and HALFPIECECOUNTER:=HALFPIECECOUNTER+1         |

#+ATTR_LATEX: :caption  \caption{Arm From Conveyor Belt to Press Module Transitions.} :align cm{8cm}
| Transitions | Meaning                                                                  |
|-------------+--------------------------------------------------------------------------|
| t72         | Arm Raised                                                               |
| tt73        | T=1.5s                                                                   |
