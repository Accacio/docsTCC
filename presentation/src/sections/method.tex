...
\end{figure}
\note{
progama daoct criado para fazer obtenção dos caminhos, modificação e
implementação do algoritmo de modelagem.
}
\end{frame}
...
\note{
\begin{itemize}
\item Como usa-se um método de caixa-preta e os caminhos não são conhecidos, eles
são extraídos do csv da seguinte forma.
\item Consideramos a seguinte sequencia extraída do csv
